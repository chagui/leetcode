...
TEST(IntegerToRoman, One) { EXPECT_EQ(Solution().intToRoman(1), "I"); }

TEST(IntegerToRoman, Three) { EXPECT_EQ(Solution().intToRoman(3), "III"); }

TEST(IntegerToRoman, Four) { EXPECT_EQ(Solution().intToRoman(4), "IV"); }
